...
```console
sudo sh -c '(curl -L https://github.com/globalbioticinteractions/nomer/releases/download/0.2.12/nomer.jar) > /usr/local/bin/nomer && chmod +x /usr/local/bin/nomer' && nomer install-manpage && nomer clean && nomer version
```
...
$ nomer matchers -v
```
Result as of v0.2.4 (Oct 2021) is formatted as a table below:
