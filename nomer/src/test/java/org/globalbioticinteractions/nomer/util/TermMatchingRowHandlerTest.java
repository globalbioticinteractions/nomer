...
public class TermMatchingRowHandlerTest {
    ...
    public void resolveWithEnricher() throws IOException, PropertyEnricherException {
        ...
        MatchUtil.resolve(is, new TermMatchingRowHandler(os, matcher, MatchTestUtil.contextWithoutReplace()));
    ...
    public void resolveGlobalNamesAppendFuzzyMatch() throws IOException, PropertyEnricherException {
        ...
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        MatchUtil.resolve(is, new TermMatchingRowHandler(os, new GlobalNamesService(), MatchTestUtil.contextWithoutReplace()));
    ...
    public void resolveGlobalNamesBatch() throws IOException, PropertyEnricherException {
        ...
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        MatchUtil.resolve(is, new TermMatchingRowHandler(os, new GlobalNamesService(GlobalNamesSources.NCBI), MatchTestUtil.contextWithReplace()));
    ...
    public void resolveTaxonCacheBatch() throws IOException, PropertyEnricherException {
        InputStream is = IOUtils.toInputStream("NCBI:9606\tHomo sapiens\tone");
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        MatchUtil.resolve(is, new TermMatchingRowHandler(os, MatchTestUtil.createTaxonCacheService(), MatchTestUtil.contextWithReplace()));
        assertThat(os.toString(), containsString("NCBI:9606\tHomo sapiens\tone\n"));
    }
    ...
    public void resolveGlobalNamesBatchAppend() throws IOException, PropertyEnricherException {
        InputStream is = IOUtils.toInputStream("NCBI:9606\tHomo sapiens\tone");
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        MatchUtil.resolve(is, new TermMatchingRowHandler(os, new GlobalNamesService(GlobalNamesSources.NCBI), MatchTestUtil.contextWithoutReplace()));
