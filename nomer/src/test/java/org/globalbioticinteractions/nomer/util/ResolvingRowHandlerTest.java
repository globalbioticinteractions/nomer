...
public class ResolvingRowHandlerTest {
    ...
    public void resolve() throws IOException, PropertyEnricherException {
        ...
        final PropertyEnricher enricher = new MatchTestUtil.PropertyEnricherMatch();
        MatchUtil.resolve(is, new ResolvingRowHandler(false, os, enricher));
    ...
    public void resolveReplace() throws IOException, PropertyEnricherException {
        InputStream is = IOUtils.toInputStream("NCBI:9606\tHomo sapiens\tone");
        ByteArrayOutputStream os = new ByteArrayOutputStream();
        final MatchTestUtil.PropertyEnricherPassThrough enricher = new MatchTestUtil.PropertyEnricherPassThrough();
        MatchUtil.resolve(is, new ResolvingRowHandler(true, os, enricher));
