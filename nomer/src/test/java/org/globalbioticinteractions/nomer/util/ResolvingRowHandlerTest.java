...
import static org.globalbioticinteractions.nomer.util.MatchTestUtil.contextWithoutReplace;
...
public class ResolvingRowHandlerTest {
    ...
    public void resolve() throws IOException, PropertyEnricherException {
        ...
        MatchUtil.resolve(is, new ResolvingRowHandler(os, enricher, contextWithoutReplace()));
    ...
    public void resolveReplace() throws IOException, PropertyEnricherException {
        ...
        MatchUtil.resolve(is, new ResolvingRowHandler(os, enricher, contextWithReplace()));
