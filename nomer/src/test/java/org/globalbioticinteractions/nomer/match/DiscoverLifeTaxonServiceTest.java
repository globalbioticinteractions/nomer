...
public class DiscoverLifeTaxonServiceTest extends DiscoverLifeTaxonServiceTestBase {
    ...
    private TermMatcherContext getTmpContext() {
        return new TermMatcherContext() {
            ...
            public InputStream retrieve(URI uri) throws IOException {
                return DiscoverLifeTaxonServiceTestBase.class.getResourceAsStream("discoverlife-bees.html");
            }
