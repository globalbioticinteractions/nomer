...
@CommandLine.Command(name = "replace", description = "Replace exact term matches in row from stdin. The input schema is used to select the id and/or name to match to. The output schema is used to select the columns to write into. If a term has multiple matches, first match is used.")
