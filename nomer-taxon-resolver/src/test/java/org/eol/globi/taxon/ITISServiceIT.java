...
public class ITISServiceIT {
    ...
    @Test
    public void lookupPathByAcceptedTSNLongURL() throws PropertyEnricherException {
        ITISService itisService = new ITISService();
        HashMap<String, String> props = new HashMap<String, String>() {{
            put(PropertyAndValueDictionary.EXTERNAL_ID, "https://www.itis.gov/servlet/SingleRpt/SingleRpt?search_topic=TSN&search_value=692068");
        }};
        Map<String, String> enrich = itisService.enrich(props);
        assertThat(enrich.get(PropertyAndValueDictionary.EXTERNAL_ID), is("ITIS:692068"));
        assertPathLength(enrich, 15);
