...
public class NCBIServiceTest {
    ...
    protected NCBIService getEnricher() {
        return new NCBIService(new ResourceService() {
            @Override
            public InputStream retrieve(URI resourceName) throws IOException {
                HashMap<String, String> requestCache = new HashMap<String, String>() {{
                    put("https://eutils.ncbi.nlm.nih.gov:443/entrez/eutils/efetch.fcgi?db=taxonomy&id=9606&email=info%2540globalbioticinteractions.org&tool=10.5281%252Fzenodo.1145474", "/org/globalbioticinteractions/nomer/match/ncbi/ncbi-web-reply-1.xml");
                    put("https://eutils.ncbi.nlm.nih.gov:443/entrez/eutils/efetch.fcgi?db=taxonomy&id=11111111&email=info%2540globalbioticinteractions.org&tool=10.5281%252Fzenodo.1145474", "/org/globalbioticinteractions/nomer/match/ncbi/ncbi-web-reply-2.xml");
                    put("https://eutils.ncbi.nlm.nih.gov:443/entrez/eutils/efetch.fcgi?db=taxonomy&id=235106&email=info%2540globalbioticinteractions.org&tool=10.5281%252Fzenodo.1145474", "/org/globalbioticinteractions/nomer/match/ncbi/ncbi-web-reply-3.xml");
                    put("https://eutils.ncbi.nlm.nih.gov:443/entrez/eutils/efetch.fcgi?db=taxonomy&id=191217&email=info%2540globalbioticinteractions.org&tool=10.5281%252Fzenodo.1145474", "/org/globalbioticinteractions/nomer/match/ncbi/ncbi-web-reply-4.xml");
                }};
                String resourceCacheLocation = requestCache.get(resourceName.toString());
                if (StringUtils.isBlank(resourceCacheLocation)) {
                    throw new IOException();
                }
                return getClass().getResourceAsStream(resourceCacheLocation);
            }
        });
    }
    ...
    public void lookupPathByTaxonId() throws PropertyEnricherException {
        PropertyEnricher enricher = getEnricher();
        ...
        assertThat(enrich.get(PropertyAndValueDictionary.COMMON_NAMES), is("human @en"));
    }
    ...
    public void parseInconsistentPathWithAltNCBI191217() throws IOException, PropertyEnricherException {
        ...
        getEnricher().parseAndPopulate(enriched, "bla", data);
