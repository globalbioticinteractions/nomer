...
public class NCBIServiceTest {
    ...
    public void lookupPathByTaxonId() throws PropertyEnricherException {
        ...
        assertThat(enrich.get(PropertyAndValueDictionary.PATH_NAMES), is(" | superkingdom | clade | kingdom | clade | clade | clade | phylum | subphylum | clade | clade | clade | clade | superclass | class | clade | clade | class | clade | clade | clade | superorder | order | suborder | infraorder | parvorder | superfamily | family | subfamily | genus | species"));
