...
public class INaturalistTaxonServiceTest {
    ...
    public void lookupByCode() throws IOException, PropertyEnricherException {
        ...
        assertThat(enriched.get(PropertyAndValueDictionary.PATH_IDS), is("INAT_TAXON:47126 | INAT_TAXON:211194 | INAT_TAXON:47125 | INAT_TAXON:47124 | INAT_TAXON:47123 | INAT_TAXON:47122 | INAT_TAXON:507502 | INAT_TAXON:746869 | INAT_TAXON:70037 | INAT_TAXON:406089"));
        assertThat(enriched.get(PropertyAndValueDictionary.PATH_NAMES), is("kingdom | phylum | subphylum | class | order | family | subfamily | tribe | genus | species"));
        assertThat(enriched.get(PropertyAndValueDictionary.PATH), is("Plantae | Tracheophyta | Angiospermae | Magnoliopsida | Fabales | Fabaceae | Faboideae | Sophoreae | Sophora | Sophora prostrata"));
    }
    @Test
